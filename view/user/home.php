...
<body>
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-9 col-md-10">
                                <div class="hero__caption">
                                    <h1>Tìm kiếm cơ hội việc làm tốt nhất trên Jobfinder</h1>
                                </div>
                            </div>
                        </div>
                        <!-- Search Box -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="browse-btn2 text-center mt-50">
                            <a href="?mod=job" class="border-btn2">Xem tất cả</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="online-cv cv-bg section-overly pt-90 pb-120" data-background="public/img/gallery/cv_bg.jpg">
            <div class="container">
        ...
        <div class="apply-process-area apply-bg pt-150 pb-150" data-background="public/img/gallery/how-applybg.png">
            <div class="container">
                <!-- Section Tittle -->
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="support-location-img">
                            <img src="public/img/service/support-img.jpg" alt="">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="public/img/blog/home-blog1.jpg" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="public/img/blog/home-blog2.jpg" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
